...
async function createProduct(reqData) {
  ...
  if (!topLevel) {
    ...
    console.log("level1 was not found hence creating new Category")
  ...
  if (!secondLevel) {
    console.log("level2 was not found hence creating new Category")
  ...
  if (!thirdLevel) {
    console.log("level3 was not found hence creating new Category")
...
async function getAllProducts(reqQuery) {
  ...
  if (category) {
    console.log("category was called here !!!!!!!!!!!!!!!!",category)
  ...
  if (minPrice && maxPrice) {
    console.log("prices was callled ^^^^^^^^^^^^^^^^^^^66")
